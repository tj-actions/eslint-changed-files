...
| ignore\_config\_path | string | false    | `"false"`                                  | Run [ESlint](https://eslint.org/) without --config flag,<br>helpful when you have a<br>mono repository with multiple sub<br>projects eash with a different<br>.eslintrc file                                                                                                                                       |
