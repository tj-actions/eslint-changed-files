...
| fail\_on\_error    | string | false    | `"false"`                                  | Exit code for reviewdog when<br>errors are found \[true,false] Default<br>is `false`.                                                                                                                                                                                                                               |
...
| filter\_mode      | string | false    | `"added"`                                  | [Filtering mode](https://github.com/reviewdog/reviewdog#filter-mode) for the reviewdog<br>command \[added,diff\_context,file,nofilter]. Default is added.<br>                                                                                                                                                        |
