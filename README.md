...
...:
    ...
    steps:
      ...
      - name: Run eslint on changed files
        uses: tj-actions/eslint-changed-files@v12
        with:
...
| ignore\_config\_path | string | false    | `"false"`                                  | Run [ESlint](https://eslint.org/) without --config flag,<br>helpful when you have nested<br>folders with .eslintrc files                                                                                                                                                                                           |
