...
...:
    ...
    steps:
      ...
      - name: Run eslint on changed files
        uses: tj-actions/eslint-changed-files@v9.1
        with:
...
| filter\_mode      | string | false    | `"added"`                                  | reviewdog [filtering mode](https://github.com/reviewdog/reviewdog#filter-mode).                                                                                                                                                                                                                                    |
| ignore\_path      | string | false    |                                            | [ESlint](https://eslint.org/) [ignore file](https://eslint.org/docs/user-guide/configuring/ignoring-code)                                                                                                                                                                                                          |
| reporter         | string | false    | `"github-pr-review"`                       | reviewdog [reporter](https://github.com/reviewdog/reviewdog#reporters).                                                                                                                                                                                                                                            |
